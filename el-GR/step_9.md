...
Εάν ακολουθείς το μονοπάτι [Περισσότερη Scratch](https://projects.raspberrypi.org/el-GR/pathways/further-scratch), μπορείς να προχωρήσεις στο έργο [Καλως ήρθες στον κόσμο μου](https://projects.raspberrypi.org/el-GR/projects/welcome-to-my-world). Σε αυτό το έργο, θα δημιουργήσεις τον δικό σου εικονικό κόσμο.
